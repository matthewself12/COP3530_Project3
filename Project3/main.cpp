...
int main() {
    ...
    cout << "What would you like to filter by?: Airline or Airport" << endl;
    cin >> filterBy;
    ...
    if(filterBy == "Airport"){
        ...
        cout << "Here are the top three airlines at " << airportSortBy << " with their corresponding average departure delay times at " << airportSortBy << ": " << endl;
